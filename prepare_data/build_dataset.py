...
def task_generator_filelist(filelist, wav_root, vq_root, spk_root):
    ...
    values:
    [
    (PosixPath('8713_300047_000002_000000.wav'), 'His life was passed like this', ['zh', 'en'], None),
...
def run_task_kx_data(task):
    ...
    for file, text, languages, phones in subset:
        ...
        try:
            ...
            # Failed to parse ljspeech/LJ034-0072.wav: 'NoneType' object has no attribute 'split'
            continue
